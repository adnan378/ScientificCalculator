...
public class MainActivity extends AppCompatActivity {
    ...
    public TextView inputDisplay,outputDisplay;
    //private DecimalFormat decimalFormat;
    private MaterialButton button0,button1,button2,button3,button4,button5,button6,button7,button8,button9,buttonDot,
            buttonAdd,buttonSubtract,buttonMultiplication,buttonDivision,buttonPercent,buttonEqual,buttonClear,buttonOff;
    @Override
